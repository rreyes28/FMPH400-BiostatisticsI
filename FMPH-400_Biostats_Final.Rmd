...
boxplot(Hypertens$SBP.Change~Hypertens$Diabetes, names = c("Non-Diabetic", "Diabetic"), main="SBP Change in Diabetics vs. Non-Diabetics", xlab = "Presence or Absence of Diabetes", ylab = "Systolic Blood Pressure Change",
